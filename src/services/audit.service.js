...
const ACTIONS = Object.freeze({
  ...
  WHATSAPP_CUSTOMER_CREATED: 'WHATSAPP_CUSTOMER_CREATED',
  WHATSAPP_SESSION_STARTED: 'WHATSAPP_SESSION_STARTED',
  FARE_CONFIG_CREATED: 'FARE_CONFIG_CREATED',
  FARE_CONFIG_UPDATED: 'FARE_CONFIG_UPDATED',
  FARE_CONFIG_ACTIVATED: 'FARE_CONFIG_ACTIVATED',
  FARE_CONFIG_DEACTIVATED: 'FARE_CONFIG_DEACTIVATED',
  SURGE_AREA_CREATED: 'SURGE_AREA_CREATED',
  SURGE_AREA_UPDATED: 'SURGE_AREA_UPDATED',
  SURGE_AREA_DEACTIVATED: 'SURGE_AREA_DEACTIVATED',
  SURGE_RULE_UPDATED: 'SURGE_RULE_UPDATED',
  TEMP_DRIVER_CREATED: 'TEMP_DRIVER_CREATED',
  TEMP_DRIVER_RELEASED: 'TEMP_DRIVER_RELEASED',
  VEHICLE_CLASS_CREATED: 'VEHICLE_CLASS_CREATED',
  VEHICLE_CLASS_UPDATED: 'VEHICLE_CLASS_UPDATED',
  VEHICLE_CLASS_ACTIVATED: 'VEHICLE_CLASS_ACTIVATED',
  VEHICLE_CLASS_DEACTIVATED: 'VEHICLE_CLASS_DEACTIVATED',
  VEHICLE_CLASS_IMAGE_ADDED: 'VEHICLE_CLASS_IMAGE_ADDED',
  VEHICLE_CLASS_IMAGE_REMOVED: 'VEHICLE_CLASS_IMAGE_REMOVED',
});
